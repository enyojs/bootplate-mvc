...
// ----------------------
// `App.Divider` is a control that allows the selection of an annotated
...
// the `controller` property to `App.documents`, `onSelect` is
// dispatched and handled in `App.documents` (since we don't handle it
