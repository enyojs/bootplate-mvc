(function () {
  ...
  enyo.kind({
    ...
    published: {
      ...
      // the outer-most-commonly-available-controller to be
      ...
      // the roller has selected. We present this property via
      // `enyo.Bindings` from the outer-most controller so any
